...
## II. ESTUDIO A FONDO: BERLÍN, ALEMANIA (LA METRÓPOLI SOBRE EL URSTROMTAL)
...
```
PERFIL HIDROGEOLÓGICO DE BERLÍN (URSTROMTAL)
...
### 2. Marco Legal Alemán: Exención y Notificación Estratégica
...
## III. ESTUDIO COMPARADO: SAN DIEGO / CALIFORNIA (EL VECINO BINACIONAL)
...
```
CUENCA TRANSFRONTERIZA TIJUANA - SAN DIEGO (MISMO ACUÍFERO)
┌──────────────────────────────────────────────┬──────────────────────────────────────────────┐
...
### 2. La Figura Legal de los *De Minimis Extractors*
...
## IV. ESTUDIO COMPARADO: LIMA, PERÚ (VALLES DEL RÍMAC, LURÍN Y SURCO)
...
```
DIAGRAMA TÉCNICO DE SAND POINT (EXTRACCIÓN SOMERA FRUGAL)
...
## VI. EL "HACK" GEOTÉCNICO: SUB-DRENAJE Y ESTABILIZACIÓN DE LADERAS EN TIJUANA
...
```
MATRIZ DE IMPACTO GEOTÉCNICO-HIDROLÓGICO EN TIJUANA
┌────────────────────────┬─────────────────────────────┬─────────────────────────────┐
...
## VII. SÍNTESIS DE DERECHO COMPARADO APLICADA AL MARCO MEXICANO
...
```
TABLA COMPARATIVA DE REGULACIÓN DE EXTRACCIÓN SOMERA DOMÉSTICA
┌──────────────────┬──────────────────────┬──────────────────────┬──────────────────────────────┐
...
## VIII. CONCLUSIONES Y RECOMENDACIONES PARA TIJUANA
...
*Documento de Trabajo Técnico-Jurídico generado para el Repositorio Oficial de AquaResiliencia Tijuana 2026.*  
